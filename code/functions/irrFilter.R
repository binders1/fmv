...
# Purpose: Highly specific function for creating binary indicators 
# for whether a parcel has been irrigated a) ever, or b) in the last n years

# See ~fmv/code/import/data_clean.R for use

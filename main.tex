...
\begin{figure}
    \centering
    \includegraphics[width=6in]{exhibits/fcb_importance_all.png}
...
\begin{figure}
    \centering
    \includegraphics[width=6in]{exhibits/nolte_resid_time.png}
...
\begin{figure}
    \centering
    \includegraphics[width=6in]{exhibits/county_compare_boxplot.png}
...
\begin{figure}
    \centering
    \includegraphics[width=6in]{exhibits/compare_county_nobs_perf.png}
...
We attempt to solve this seemingly unavoidable trade-off between model size and observation homogeneity by specifying models at the level of the farm resource region.

% Motivate FRR model by discussing compare_county_nobs_perf
% and how we see better performance in higher density counties
% So the question is whether we can retain the spatial-homo-
% geneity that comes with counties while harnessing the power 
% of higher density models

% Then go into FRR modeling benefits

...
To Nolte's base county model ("Nolte"), we add variables on climatic conditions, soil type, and housing market values.

\subsection{Extended Coverage}

% First talk about county level results in the context of benefits of added variables. Here's where to put the HPI stuff
% Variable importance is big here
